...
export default function ThirdRoute() {
  ...
  const NORMAL_MIN_HUMIDITY = 30;
  const NORMAL_MAX_HUMIDITY = 60;
        ...
        useCallback(() => {
          const fetchData = async () => {
            try {
              ...
              const humidityRows = rows
              .filter((r: any) => r?.ts != null && r?.humidity != null)
              .map((r: any) => ({
